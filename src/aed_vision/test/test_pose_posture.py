...
def person(shoulders, hips, knees, confidence=1.0):
    ...
    for indexes, center in (
        ((5, 6), shoulders), ((11, 12), hips), ((13, 14), knees)
    ):
...
class PosePostureTest(unittest.TestCase):
    def test_standing(self):
        ...
        self.assertEqual(classify_posture(pose, (30, 5, 75, 105))[0], "STANDING")

    def test_sitting(self):
        pose = person((50, 20), (52, 55), (85, 65))
        self.assertEqual(classify_posture(pose, (25, 5, 105, 90))[0], "SITTING")

    def test_fallen(self):
        pose = person((30, 50), (80, 55), (115, 58))
        posture, metrics = classify_posture(pose, (10, 30, 135, 80))
        self.assertEqual(posture, "FALLEN")
        self.assertLessEqual(metrics["torso_angle_deg"], 40.0)
